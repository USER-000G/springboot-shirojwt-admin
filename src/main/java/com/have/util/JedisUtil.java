...
public class JedisUtil {
    ...
    public static Object getObject(String key) {
        try {
            ...
            if (StringUtil.isNotEmpty(str)) {
                return SerializableUtil.deserialize(jedis.get(key.getBytes()));
            }
        } catch (Exception e) {
     ...
     * 设置redis键值-object
     *
     * @param prefixShiroRefreshToken
     * @param key
     * @param value
     * @return java.lang.String
     */
    public static String setObject(String prefixShiroRefreshToken, String key, Object value) {
        try (Jedis jedis = jedisPool.getResource()) {
            return jedis.set(key.getBytes(), SerializableUtil.serizlize(value));
        } catch (Exception e) {
    ...
    public static String setObject(String key, Object value, int expiretime) {
        String result;
        try (Jedis jedis = jedisPool.getResource()) {
            result = jedis.set(key.getBytes(), SerializableUtil.serizlize(value));
    ...
    public static Boolean exists(String key) {
        try {
            Jedis jedis = jedisPool.getResource();
            log.info(jedis.exists("jedis key 是否存在: " + key.getBytes()).toString());
